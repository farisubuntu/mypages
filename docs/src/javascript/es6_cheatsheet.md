...
> From https://github.com/DrkSephy/es6-cheatsheet/blob/master/README.md 
...
to create modules on the client-side  __(lets you require('modules') in the browser by bundling up all of your dependencies.)__, and [require](https://nodejs.org/api/modules.html#modules_module_require_id)
in **Node.js** __(The module.require() method provides a way to load a module as if require() was called from the original module)__. With ES6, we can now directly use modules of all types
(AMD and CommonJS).
